...
class MOFNet(nn.Module):
    def __init__(self, cfg):
        ...
        if cfg.cnet != "twins" or cfg.fnet != "twins":
            raise ValueError("SIS-Motion's MOFNet subset requires twins encoders")
        ...
        if self.cfg.Tfusion != "stack":
            raise ValueError("SIS-Motion's MOFNet subset requires Tfusion='stack'")
        print("[Using stack.]")
